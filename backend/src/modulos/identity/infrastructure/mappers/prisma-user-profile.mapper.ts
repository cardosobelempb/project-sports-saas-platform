...
export class PrismaUserProfileMapper {
    ...
    return UserProfileEntity.create(
      {
        ...
        birthDate: raw.birthDate ? DateOfBirthVO.create(raw.birthDate) : null,
        phone: raw.phone ? PhoneVO.create(raw.phone) : null,
        avatarUrl: raw.avatarUrl,
        documentType: raw.documentType as DocumentType,
        documentNumber: raw.documentNumber,
        status: raw.status as UserProfileStatus,
      },
  ...
  static toDTO(entity: UserProfileEntity): UserProfileDto {
    return {
      ...
      birthDate: entity.birthDate ? entity.birthDate.getValue() : null,
